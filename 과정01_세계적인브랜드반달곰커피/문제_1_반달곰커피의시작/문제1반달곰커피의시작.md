...
2. **Python 설치**
   ...
   - [Python.org](https://www.python.org/) 에 접속하여 최신 버전의 파이썬 설치 파일을 다운로드합니다.
      ...
      3. **설치 옵션 선택**
         - `Add Python to PATH`:  
         이 옵션을 선택하면, 명령 프롬프트나 터미널에서 `python` 명령어를 바로 사용할 수 있습니다.
         - `Customize installation`:  
         원하는 설치 위치를 지정하거나, 추가 구성 요소를 설치할 수 있습니다.

      4. **설치 완료**
         - 설치가 완료되면 Python 사용이 가능합니다.

      5. **설치 확인**
         - 명령 프롬프트(Windows) 또는 터미널(macOS, Linux) 실행  
         - 다음 명령어 입력:
         ```bash
         python
         ```
         - 파이썬 인터프리터가 실행되면 다음 명령어 입력:
         ```python
         print("Hello, world!")
         ```
         - 출력 결과:
