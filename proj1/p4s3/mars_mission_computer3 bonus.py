...
class MissionComputer:
    def __init__(self):
        ...
        self.setting = {
            ...
            "cpu_type": False,
            "cpu_cores": False,
            "memory_total_MB": False,
            "cpu_usage_percent": False,
            "memory_usage_percent": False
        }
        self.load_setting()  # 설정 파일 로딩

    def load_setting(self):
        """setting.txt 파일을 읽어 설정값을 반영합니다."""
    ...
    def get_mission_computer_info(self):
        ...
        info = { key: getter() for key, getter in info_sources.items() if self.setting[key]}
    ...
    def get_mission_computer_load(self):
        ...
        load = { key: getter()for key, getter in load_sources.items() if self.setting[key]}
